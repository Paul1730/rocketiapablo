...
import { ArrowRight, Lock, TrendingUp, Volume2, VolumeX } from 'lucide-react';
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 800,
          background:
            'radial-gradient(circle, rgba(0,210,255,0.05) 0%, rgba(139,92,246,0.04) 35%, transparent 65%)',
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div {...fadeUp(0.1)} className="mb-8 flex justify-center">
          ...
          >
            <span
              className="w-1.5 h-1.5 rounded-full bg-rocket-cyan animate-pulse"
        ...
        >
          ...
          <span className="block mt-1">
            ...
            <span
              ...
              style={{ filter: 'drop-shadow(0 0 12px rgba(0,210,255,0.8))' }}
            >
              .
            </span>
          </span>
        ...
        >
          ...
          para{' '}
          <strong className="text-white font-semibold">crear, vender y escalar</strong>{' '}
          tu negocio con IA.
        </motion.p>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(0,210,255,0.2), rgba(139,92,246,0.2), rgba(236,72,153,0.15))',
              filter: 'blur(1px)',
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                '0 40px 100px rgba(0,0,0,0.55), 0 0 60px rgba(0,210,255,0.06)',
        ...
        >
          ...
          <motion.a
            ...
            style={{
              ...
              border: ctaEnabled
                ? '1.5px solid rgba(0,210,255,0.4)'
              ...
              filter: ctaEnabled ? 'none' : 'grayscale(1)',
            }}
          >
            {ctaEnabled ? (
              <>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to bottom, transparent, rgba(5,8,20,0.8))',
        }}
      />
    </section>
  );
